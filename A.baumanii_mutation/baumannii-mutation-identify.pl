...
=head1 Description
	...
	Mutations identification for A.baumanii before and after adaptive evolution against to the bacteriophage
	
=head1 Usage

	perl baumannii-mutation-identify.pl -refname <name of reference genome > -aligned <aligned fasta>
