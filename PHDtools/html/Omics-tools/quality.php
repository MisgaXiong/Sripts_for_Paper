<?php
    ...
    $analysis_path = "/home/dell/data/Web-Server/WGS-quality/".$dtime."/";
    $qc_pipeline = "/var/www/other_scripts/bio-pipelines/Wgs-quality/wgs-quality.pl";
    $Result_store_path = "/home/dell/data/Web-Server/Result-store/WGS-quality/".$dtime."/";
	...
	shell_exec("mkdir ".$analysis_path.".../");
        ...
        $command = $perl_path." ".$qc_pipeline." -WorkPath ".$analysis_path." -FQ1 ".$R1_filename." -FQ2 ".$R2_filename." -REF ".$Ref_filename." -StorePath ".$Result_store_path;
        shell_exec($command);
        ...
        if($_POST['waiting'] == "simultaneous"){
            ...
            $download_path = "../Download-tools/doDownload.php?filename=".$Result_store_path."Quality_Reports.zip";
        }else{
            $visualization = "visibility:hidden";
            echo "Your Download code is: WGS-quality_".$dtime."<br>";
...
<html lang="en">
    <head>
        <title>WGS quality report</title>
            <meta charset="UTF-8"/>
    </head>
<body>
    <a href="<?php echo $download_path?>" style="<?php echo $visualization?>">DownloadReportFile</a><br>
</body>
</html>
